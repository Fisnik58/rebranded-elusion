...
export default function App({ Component, pageProps }) {
  ...
  return (
    <>
      ...
      <div className="container" id="containerofTheTeam" style={{paddingTop:"100px",paddingBottom:"100px"}}>
        <div style={{display:"flex",justifyContent:"center"}}>
           <h4 className="subtitle text-center fadein">The team</h4>
        ...
        <div className="grid-container-3 mx-auto">
          <div className="head-card ">
            <div class="card fadein">
            <img class="card-img-top img-fluid" src="/img/avatar.jpg" alt="Card image cap" />
      ...
      <div className="d-flex justify-content-center fadein">
        <hr
          style={{ height: "3px", backgroundColor: "#203042", width: "90%" }}
        />
      </div>
      <div className="container fadein">
        <p style={{ color: "#A2B3C6" }}>
          Copyright Elusion™ © 2022. All rights reserved
        </p>
      </div>
    </>
  );
